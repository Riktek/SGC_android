...
public class CustomAarrayAdapterNormal extends ArrayAdapter {


    private List<String> coleccionList;
    private int id_album;
    public CustomAarrayAdapterNormal(Context context, List<String> list, int id_album)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        lamina tmp = lamina.getNormalByNumero(numero, id_album);
...
// initialize textview
        ...
        holder.tv.setText("Item " + coleccionList.get(position));
